...
import com.example.evaluacion_u1.ui.theme.screens.CalificacionUnidad
...
fun AppNavigation(){
    ...
    NavHost(navController = navController, startDestination = "login"){
        ...
        composable(route="CalUnidad"){ CalificacionUnidad(navController = navController, viewModel= viewModel)}
